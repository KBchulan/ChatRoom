...
### ✨ Features
- Add contact grouping and friend application UI

## [2026-01-10]

### ✨ Features
- **[all]** 将路由可用性检查移至 URL 解析之后，使用解析后的 path 进行判断，新增好友申请对话框，完善搜索流程与加载状态
...
### 🐛 Bug Fixes
- **[readme]** 修复文档路径错误，fuck copilot, tap 真不好用
