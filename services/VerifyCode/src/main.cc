...
int main(int argc, char* argv[])
{
  ...
  try
  {
    auto server_addr = std::string(global::server::SERVER_ADDRESS) + ":" + std::to_string(options->port);
    ...
    tools::Logger::getInstance().info("VerifyCode Server listening on {}", server_addr);
